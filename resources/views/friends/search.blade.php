            ...
            <div class="card-body">
                <form action="{{ route('friends.search') }}" method="GET" class="mb-4">
                    <div class="input-group">
                        ...
                        <button class="btn" type="submit" id="button-search" style="background-color: #e50914; color: white;">
                ...
                @if($query)
                    ...
                    @if($results->isEmpty())
                        <div class="text-center py-5">
                            <i class="fas fa-search fa-3x mb-3" style="color: #e50914;"></i>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center text-white" style="width: 50px; height: 50px; background-color: #e50914 !important;">
                                                ...
                                                @else
                                                    <button type="button" onclick="agregarAmigo('{{ $user->id }}')" class="btn add-friend-btn" style="background-color: #e50914; color: white;" data-user-id="{{ $user->id }}">
                ...
                @else
                    <div class="text-center py-5">
                        <i class="fas fa-users fa-3x mb-3" style="color: #e50914;"></i>
